...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
		...
		String tenMuc = (String) request.getAttribute("tenMuc");
	%>
	<div id="body">
		<div class="content">
			<div class="loi">
			...
			<div id="blog">
				<h2><% out.print("Tìm kiếm theo tiêu đề \""+tieuDe+"\"");%></h2>
				<ul>
					<%
				...
				<div class="right ">
					...
					<%	
						...
						String search="";
						String urlPage = request.getContextPath()+"/search-news?page=";
						if(tieuDe!=null){
							search="&tieuDe="+request.getParameter("tieuDe");
						}
